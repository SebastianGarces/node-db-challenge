...
-   [ ] Explain the difference between `Relational Databases` and `SQL`.
    ...
    R: Relational Databases are a type of databases vs SQL being a query language.

-   [ ] Why do tables need a `primary key`?

    R: As the identifier of that table.
...
-   [ ] What do we need in order to have a _many to many_ relationship between two tables.
    ...
    R: A multi-table that includes the primary keys of the tables it wishes to reference as foreign keys.
